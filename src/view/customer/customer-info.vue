                    ...
                    <Row :gutter="24" class='row-wrap'>
                        ...
                        <FormItem label="计量方式" prop="measurementType">
                            <Select v-model="formValidate.measurementType">
                                <Option v-for="item in measurementTypeList" :value="item.name" :key="item.id">{{
                                    item.name }}</Option>
                            </Select>
                        </FormItem>
                        </Col>
                    ...
                    <Row :gutter="24" class='row-wrap'>
                        ...
                        <FormItem label="服务类型" prop="serviceType">
                            <Select v-model="formValidate.serviceType">
                                <Option v-for="item in serviceTypeList" :value="item.name" :key="item.id">{{ item.name
                                    }}</Option>
                            </Select>
                        </FormItem>
                        </Col>
                    ...
                    <Row :gutter="24" class='row-wrap'>
                        ...
                        <FormItem label="用电类别" prop="electricityCategory">
                            <Select v-model="formValidate.electricityCategory">
                                <Option v-for="item in electricityCategoryList" :value="item.name" :key="item.id">{{
                                    item.name }}</Option>
                            </Select>
                        </FormItem>
                        </Col>
    ...
    export default {
        ...
        data() {
            ...
            return {
                listData: [],
                tableColumns: [],
                tableColumnsChecked: ['companyName', 'companyLegalName', 'address', 'industry', 'serviceType',
                    'userLevel', 'creationTime'
                ],
                industryList: [],
                measurementTypeList: [],
                serviceTypeList: [],
                    ...
                    getCustomerList(this.queryParam).then(
                        res => {
                            ...
                            this.listData.forEach(element => {
                                ...
                                element.contractSigningDate = formatData(element.contractSigningDate,
                                    'day')
                            })
