    ...
    export default {
        ...
        methods: {
            ...
            getHighVoltageInfoData() {
                return new Promise((resolve, reject) => {
                    getHighVoltageInformationList(this.powerDistributionRoomId, this.queryParam).then(
                            res => {
                                this.isLoading = false;
            ...
            getLowVoltageInfoData() {
                return new Promise((resolve, reject) => {
                    getLowVoltageInformationList(this.powerDistributionRoomId, this.queryParam).then(
                            res => {
                                this.isLoading = false;
            ...
            getTransInfoData() {
                return new Promise((resolve, reject) => {
                    getTransInformationList(this.powerDistributionRoomId, this.queryParam).then(
                            res => {
                                this.isLoading = false;
